                ...
                <tr key={menu._id || menu.menuId} className="border-b hover:bg-gray-50">
                  ...
                  <td className="px-5 py-3">
                    <div className="flex gap-2">
                      <button onClick={() => navigate(`/admin/menu/edit/${menu._id || menu.menuId}`)} className="p-2 border rounded-md hover:bg-gray-50"><Pencil className="w-4 h-4 text-gray-500" /></button>
