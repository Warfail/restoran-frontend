...
const handleSubmit = async (e) => {
  ...
  const menuData = {
    name: formData.name,
    price: Number(formData.price),   // ← paksa jadi number
    stock: Number(formData.stock),   // ← paksa jadi number
  ...
  console.log("Price type:", typeof menuData.price); // Harusnya "number"
  console.log("Stock type:", typeof menuData.stock); // Harusnya "number"
