    ...
    <div className="flex min-h-screen bg-gray-50 font-sans">
      ...
      <aside className="fixed left-0 top-0 w-64 h-full bg-[#E12A2C] shadow-lg z-10">
        ...
        <nav className="p-4 space-y-1">
          <button onClick={() => handleNavigation("/admin")} className="flex items-center gap-3 px-4 py-3 text-white hover:bg-white/10 rounded-lg transition w-full">
          ...
          <button onClick={() => handleNavigation("/reports")} className="flex items-center gap-3 px-4 py-3 text-white hover:bg-white/10 rounded-lg transition w-full">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between px-5 py-4 border-b border-gray-100 gap-3">
              <div className="flex gap-2">
                <button className="flex items-center gap-1.5 border border-gray-200 rounded-lg px-3 py-1.5 text-xs font-medium text-gray-700 bg-white">
                  <FilterIcon className="w-3.5 h-3.5" /> Filter Peran
                </button>
                <button className="flex items-center gap-1.5 border border-gray-200 rounded-lg px-3 py-1.5 text-xs font-medium text-gray-700 bg-white">
                  <ArrowUpDownIcon className="w-3.5 h-3.5" /> Urutkan
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <div className="flex items-center gap-2.5 mb-2">
                <div className="w-8 h-8 rounded-lg bg-green-50 flex items-center justify-center"><ShieldIcon className="w-4 h-4 text-green-600" /></div>
              ...
              <button className="text-green-600 text-sm font-semibold flex items-center gap-1 hover:gap-2 transition-all">Konfigurasi Keamanan <ArrowRightIcon className="w-3.5 h-3.5" /></button>
            </div>

            {/* Log Aktivitas */}
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <div className="flex items-center gap-2.5 mb-2">
                <div className="w-8 h-8 rounded-lg bg-amber-50 flex items-center justify-center"><HistoryIcon className="w-4 h-4 text-amber-500" /></div>
              ...
              <button className="text-amber-600 text-sm font-semibold flex items-center gap-1 hover:gap-2 transition-all">Lihat Semua Log <ArrowRightIcon className="w-3.5 h-3.5" /></button>
            </div>
          </div>
        </div>
      </main>
