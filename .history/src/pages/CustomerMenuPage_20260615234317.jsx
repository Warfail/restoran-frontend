...
export default function CustomerMenuPage() {
  ...
  const [menuItems, setMenuItems] = useState([
    ...
    { id: 6, name: "Nasi Goreng Seafood", price: 32000, category: "Nasi Goreng", image: "https://placehold.co/100x80/6b8e4a/6b8e4a", available: true },
    { id: 7, name: "Nasi Goreng Special", price: 35000, category: "Nasi Goreng", image: "https://placehold.co/100x80/5a7e3a/5a7e3a", available: true },
  ]);
    ...
    <div className="min-h-screen bg-[#FFF0F0] pb-24">
      ...
      <header className="bg-[#FFF0F0] sticky top-0 z-10">
        ...
        <div className="px-4 pb-3">
          <div className="flex items-center gap-2 bg-white rounded-full px-3.5 py-2.5 shadow-sm">
