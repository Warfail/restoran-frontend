...
import { Bell, User, LogOut, ChevronDown, ChevronUp, Check, AlertTriangle } from "lucide-react";
...
export default function KitchenDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center">
            ...
            <button
              ...
              className={`px-5 py-4 text-sm font-medium transition ${activeTab === "totalmenu" ? "text-gray-900 border-b-2 border-red-500" : "text-gray-500"}`}
            >
              Total Menu
            </button>
      ...
      {activeTab === "antrean" ? (
        <>
          {/* Category Tabs untuk Antrean */}
          <div className="border-b border-gray-200 bg-white">
            <div className="flex">
              <div className="flex-1 flex items-center justify-center gap-2 py-3.5 cursor-pointer hover:bg-gray-50 transition border-b-2 border-red-500">
                <i className="ti ti-tools-kitchen-2 text-gray-700 text-xl"></i>
                <span className="text-gray-700 font-semibold text-sm">Semua</span>
              </div>
        ...
        <>
          ...
          <div className="flex-1 bg-white p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-3">{renderMenuList(menuCategories.makanan, "makanan")}</div>
              <div className="space-y-3">{renderMenuList(menuCategories.minuman, "minuman")}</div>
              <div className="space-y-3">{renderMenuList(menuCategories.cemilan, "cemilan")}</div>
            </div>
          </div>
        </>
      )}
