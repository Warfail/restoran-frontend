      ...
      <main className="ml-64 flex-1">
        ...
        <div className="flex-1 px-8 py-8">
          ...
          <div className="flex justify-end gap-3 mt-8">
            <button onClick={() => navigate("/users")} className="flex items-center gap-2 px-5 py-2.5 bg-[#E12A2C] rounded-lg text-white text-sm font-medium hover:bg-red-700 transition">
  Batal
</button>
{/*  */}
            <button className="flex items-center gap-2 px-5 py-2.5 bg-[#1bc964] rounded-lg text-white text-sm font-medium hover:bg-green-700 transition">
