      ...
      <main className="ml-64 flex-1">
        ...
        <div className="flex items-center justify-between px-8 py-4 bg-white border-b border-gray-200">
          ...
          <div className="flex items-center gap-4">
            ...
            <HelpCircleIcon className="w-5 h-5 text-gray-500 cursor-pointer" />
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 bg-white rounded-xl border border-gray-200 p-7">
              <div className="flex items-center gap-2 mb-6">
                <UserIcon className="w-[18px] h-[18px] text-gray-700" />
            ...
            <div className="flex-1 flex flex-col gap-5">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-7">
                <div className="flex items-center gap-2 mb-6">
                  <ShieldCheckIcon className="w-[18px] h-[18px] text-gray-700" />
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-7">
                <div className="flex items-center gap-2 mb-6">
                  <LockIcon className="w-[18px] h-[18px] text-gray-700" />
