  ...
  return (
    <aside className="fixed left-0 top-0 w-64 h-full bg-[#E12A2C] shadow-lg z-10">
      ...
      <nav className="p-4 space-y-1">
        ...
        <button onClick={() => navigate("/admin/users")} className="flex items-center gap-3 px-4 py-3 text-white hover:bg-white/10 rounded-lg transition">
        ...
        <button onClick={() => navigate("/admin/reports")} className="flex items-center gap-3 px-4 py-3 text-white hover:bg-white/10 rounded-lg transition">
          <svg width="18" height="18" viewBox="0 0 18 18" fill="white">
