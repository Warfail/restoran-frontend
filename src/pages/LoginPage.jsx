    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="w-full flex flex-col sm:flex-row items-center justify-between px-6 sm:px-10 py-5 border-t border-gray-200 bg-white gap-3 sm:gap-0">
        ...
        <div className="flex items-center gap-5">
          <button type="button" onClick={() => toast("Halaman Bantuan sedang dalam tahap pengembangan.", { icon: "ℹ️" })} className="text-gray-700 text-[13px] hover:text-green-800">Bantuan</button>
          <button type="button" onClick={() => toast("Halaman Privasi sedang dalam tahap pengembangan.", { icon: "ℹ️" })} className="text-gray-700 text-[13px] hover:text-green-800">Privasi</button>
          <button type="button" onClick={() => toast("Halaman Syarat & Ketentuan sedang dalam tahap pengembangan.", { icon: "ℹ️" })} className="text-green-800 text-[13px] font-medium hover:underline">Syarat & Ketentuan</button>
        </div>
      </div>
